...
test('installed browser completes the bounded local Web research loop', async ({ page }, testInfo) => {
  ...
  await expect(page.getByRole('row', { name: /Run 1 2 0 succeeded 10017 USD 17 USD 0.17% 0% View/i })).toBeVisible()
  await expect(page.getByRole('row', { name: /Run 2 4 2 succeeded 10000 USD 0 USD 0% 0% View/i })).toBeVisible()
  ...
  await page.reload()
  await expect(page.getByRole('row', { name: /Run 3 100 0 succeeded No report Unavailable View/i })).toBeVisible()
