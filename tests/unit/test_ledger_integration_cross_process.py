...
from ea.core import (
    ...
    InstrumentSpecSetId, LedgerHandoffAction, PortfolioSnapshot, PositionBalance, PriceDomain,
...
reconciliation_snapshot = PortfolioSnapshot(
    run_id,
    spec_set.identifier,
    ...
    Sha256Digest("cc" * 32),
    (),
    (PositionBalance(instrument, CanonicalDecimal("1"), CanonicalDecimal("8")),),
    (),
    (),
)
...
reconciliation_outcome = create_reconciliation_outcome(
    ...
    local_snapshot_sha256=portfolio_snapshot_digest(reconciliation_snapshot),
    ledger_sequence=3,
...
adjustment_command = _create_reconciliation_adjustment_command(
    ...
    local_snapshot=reconciliation_snapshot,
